...
- [1. Развертывание на локальном ресурсе](#1-развертывание-на-локальном-ресурсе)
  - [1.1. Docker](#11-docker)
  - [1.2. PostgreSQL](#12-postgresql)
  - [1.3. Мониторинг](#13-мониторинг)
- [2. Перенос на хостинг](#2-перенос-на-хостинг)
  - [2.1. Сравнительный анализ провайдеров: Yandex Cloud vs Selectel vs Beget](#21-сравнительный-анализ-провайдеров-yandex-cloud-vs-selectel-vs-beget)
- [3. Миграция в Yandex Cloud](#3-миграция-в-yandex-cloud)
  - [3.1. Подготовка инфраструктуры через Terraform](#31-подготовка-инфраструктуры-через-terraform)
  - [3.2. Перенос базы данных](#32-перенос-базы-данных)
  - [3.3. Перенос сервисов](#33-перенос-сервисов)
  - [3.4. Тестирование](#34-тестирование)
  - [3.5. Мониторинг](#35-мониторинг)
  - [3.6. Организация Backup на AWS S3](#36-организация-backup-на-aws-s3)
- [4. Ролевая модель и управление доступом](#4-ролевая-модель-и-управление-доступом)
  - [4.1. Роли в системе n8n](#41-роли-в-системе-n8n)
  - [4.2. Роли в PostgreSQL](#42-роли-в-postgresql)
  - [4.3. Роли в инфраструктуре](#43-роли-в-инфраструктуре)
  - [4.4. Роли в мониторинге](#44-роли-в-мониторинге)
  - [4.5. Матрица доступа](#45-матрица-доступа)
- [5. Заключение и рекомендации](#5-заключение-и-рекомендации)
  - [5.1. Итоги](#51-итоги)
  - [5.2. Рекомендации по выбору провайдера](#52-рекомендации-по-выбору-провайдера)
  - [5.3. Дальнейшие шаги](#53-дальнейшие-шаги)
- [Приложение: Полезные команды](#приложение-полезные-команды)
- [Заключение](#заключение)

> **Дополнительно:** [Пошаговая диагностика неисправностей и первичная настройка мониторинга](diagnostic.md)
